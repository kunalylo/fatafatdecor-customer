  ...
  return (
    <div className="slide-up pb-28 bg-aurora min-h-screen">
      ...
      <div className="px-4 space-y-4">
        {/* Order Summary */}
        <div className="glass-floating rounded-[22px] p-4 space-y-3">
        ...
        {(o.delivery_slot?.date || o.requested_slot?.date) && (
          <div className="glass-floating rounded-[22px] p-4 flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-blue-100 flex items-center justify-center shrink-0">
              <Clock className="w-5 h-5 text-blue-500" />
            </div>
            <div>
              <p className="text-sm font-bold text-gray-800">Delivery Slot</p>
        ...
        {o.delivery_address && (
          <div className="glass-floating rounded-[22px] p-4 flex items-start gap-3">
            <div className="w-10 h-10 rounded-xl accent-pink flex items-center justify-center shrink-0 mt-0.5">
        ...
        {Array.isArray(o.completion_photos) && o.completion_photos.length > 0 && (
          <div className="glass-floating rounded-[22px] p-4 ring-1 ring-emerald-200">
        ...
        {o.has_gifts && o.gift_items?.length > 0 && (
          <div className="glass-floating rounded-[22px] p-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <h3 className="font-bold text-sm text-gray-800">Gift Add-ons</h3>
            </div>
            {o.gift_items.map((g, i) => (
              <div key={i} className="flex justify-between items-center py-1.5 border-b border-white/50 last:border-0">
        ...
        <div className="glass-floating rounded-[22px] p-4">
          <div className="flex items-center gap-2 mb-2">
            ...
            <h3 className="font-bold text-sm text-gray-800">Decoration Items</h3>
          </div>
